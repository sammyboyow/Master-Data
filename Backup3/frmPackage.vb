...
Public Class frmPackage
    ...
    Private Sub btnConnect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConnect.Click
        Try
            ...
            Dim str As String = "SELECT IMH_CODE, IMH_DESC, BL_DESC FROM ITEM_MASTERH INNER JOIN BILLCODE ON IMH_BILLCODE = BL_CODE"
    ...
    Private Sub btnProcess_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        For i = 0 To dPack.RowCount - 1
            ...
            desc = CStr(dPack("IDESC", i).Value.ToString)
            desc = Replace(desc, "'", "''")
            str = "if not exists(select * from icpcod where pricelist='" & dPack("ICODE", i).Value & "' and branch='" & dPack("IBRANCH", i).Value & "')" & _
                    " insert into icpcod values('" & dPack("ICODE", i).Value & "','" & desc & "','" & dPack("IBRANCH", i).Value & "','" & dPack("BLDESC", i).Value & "') " & _
                    " update icpcod set [desc]='" & desc & "',BLDesc='" & dPack("BLDESC", i).Value & "' where pricelist='" & dPack("ICODE", i).Value & "' and branch='" & dPack("ibranch", i).Value & "'"
